...
class Application(
    ...
    def push(
        ...
        An app is pushed by specifying `app_dir`, the path to an app's root
        directory. The app is composed of the files in that directory, which
        are packaged and pushed to Nextmv Cloud.
