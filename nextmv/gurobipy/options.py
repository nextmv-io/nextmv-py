...
GUROBIPY_PARAMETERS_TERMINATION = (
    options.Parameter("bar_iter_limit", int, description="Barrier iteration limit"),
    options.Parameter("best_bd_stop", float, description="Objective bound to stop optimization"),
    options.Parameter("best_obj_stop", float, description="Objective value to stop optimization"),
    options.Parameter("cutoff", float, description="Objective cutoff"),
    options.Parameter("time_limit", float, description="Time limit"),
)

GUROBIPY_PARAMETERS_TOLERANCES = (options.Parameter("mip_gap", float, description="Relative MIP optimality gap"),)

GUROBIPY_PARAMETERS_OTHER = (options.Parameter("output_flag", int, description="Solver output control"),)
